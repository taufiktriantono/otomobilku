                  ...
                  (
                    <>
                      <div className='w-full mb-2'>
                          <div className='mb-2 text-2xl text-gray-700 font-bold'>Edit Product</div>
                          <span className='text-gray-500'>Rubah informasi mobil untuk ditampilkan pada list catalog</span>
                      </div>
                      <ValidationErrors errors={errors} />
                      <div className='w-full mb-4'>
                          <label>Judul</label>
                          <input className='w-full rounded disabled:bg-gray-100' name='name' type={'text'} placeholder='Judul' value={title} onChange={handleChangeTitle}/>
                      </div>
                      <div className='w-full mb-4'>
                          <label>Merk</label>
                          <select className='w-full rounded disabled:bg-gray-100' name='merk' value={isBrandSelected} onChange={handleChangeBrand}>
                            {
                              brands.map((brand, i) => {
                                return (
                      ...
                      <div className='w-full mb-4'>
                          <label>Model</label>
                          <select className='w-full rounded disabled:bg-gray-100' name='model' value={isModelSelected} onChange={handleChangeModel}>
                            {
                              models.map((model, i) => {
                                return (
                      ...
                      <div className='w-full mb-4'>
                          ...
                          <input className='w-full rounded disabled:bg-gray-100' type={'number'} name='build_yaer' placeholder='2015' value={buildYear} onChange={handleChangeBuildYear}/>
                      </div>
                      <div className='w-full mb-4'>
                          <label>Body Mobil</label>
                          <select className='w-full rounded disabled:bg-gray-100' name='body_type' value={selectedBodyType} onChange={handleChangeBodyType}>
                            {
                      ...
                      <div className='w-full mb-4'>
                          <div className='flex justify-between'>
                              <div className='mr-4'>
                                <label>KM</label>
                                <input className='w-full rounded disabled:bg-gray-100' type={'number'} name='distance' placeholder='20000' value={distance} onChange={handleChangeDistance}/>
                              </div>
                              <div className='mr-4'>
                                <label>Bahan Bakar</label>
                                <select className='w-full rounded disabled:bg-gray-100' name='fuel' value={selectedFuel} onChange={handleChangeFuel}>
                                  {
                                    fuels.map((fuel) => {
                                      return (
                              ...
                              <div>
                                ...
                                <select className='w-full rounded disabled:bg-gray-100' name='transmission' value={selectedTransmission} onChange={handleChangeTransmission}>
                                  {
                      ...
                      <div className='w-full mb-4'>
                          ...
                          <textarea className='w-full h-32 rounded disabled:bg-gray-100' name='description' value={description} onChange={handleChangeDescription}></textarea>
                      </div>
                      <div className='w-full mb-4'>
                          <label>Kota</label>
                          <select className='w-full rounded disabled:bg-gray-100' name='city' value={selectedCity} onChange={handleChangeCity}>
                            {
                              cities.map((city) => {
                                return (
                      ...
                      <div className='w-full mb-4'>
                          ...
                          <select className='w-full rounded disabled:bg-gray-100' name='sub-district' value={selectedDistrict} onChange={handleChangeDistrict}>
                            {
                      ...
                      <div className='w-full mb-4'>
                          ...
                          <input className='w-full rounded disabled:bg-gray-100' type={'text'} name='geo_point' value={coordinate} onChange={handleChangeCoordinate}/>
                      </div>
                      <div className='w-full mb-4'>
                          <label>Harga Mobil (IDR)</label>
                          <input className='w-full rounded disabled:bg-gray-100' type={'number'} name='price' placeholder='200000000' value={price} onChange={handleChangePrice}/>
                      </div>
                      <div className='w-full mb-4'>
