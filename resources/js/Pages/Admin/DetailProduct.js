...
export default function DetailProduct(props) {
    ...
    const [isDistrictSelected, setIsDistrictSelected] = useState(product.district.district_name);
    ...
    const [fuel, setFuel] = useState(product.fuel.fuel_name);
    const [price, setPrice] = useState(product.price);
    const [transmission, setTransmission] = useState(product.transmission.transmission_name);
    ...
    }, [fetchListBrand, fetchListBodyType]);
    ...
    let [fileUploaded, setFileUploaded] = useState(product.images)
    ...
    const [fullName, setFullName] = useState(product.owner.full_name);
    const handleChangeFullName = (e) => {
      setFullName(e.target.value)
    }

    const [phoneNumber, setPhoneNumber] = useState(product.owner.phone_number);
                  ...
                  (
                    <>
                      <div className='w-full mb-2'>
                          <div className='mb-2 text-2xl text-gray-700 font-bold'>Detail Product</div>
                          <span className='text-gray-500'>Informasi mobil untuk ditampilkan pada list catalog</span>
                      </div>
                      <ValidationErrors errors={errors} />
                      <div className='w-full mb-4'>
                          <label>Judul</label>
                          <input className='w-full rounded disabled:bg-gray-100' name='name' type={'text'} placeholder='Judul' value={title} onChange={handleChangeTitle} disabled/>
                      </div>
                      <div className='w-full mb-4'>
                          <label>Merk</label>
                          <select className='w-full rounded disabled:bg-gray-100' name='merk' value={isBrandSelected} onChange={handleChangeBrand} disabled>
                            {
                              brands.map((brand, i) => {
                                return (
                      ...
                      <div className='w-full mb-4'>
                          <label>Model</label>
                          <select className='w-full rounded disabled:bg-gray-100' name='model' value={isModelSelected} onChange={handleChangeModel} disabled>
                            {
                              models.map((model, i) => {
                                return (
                      ...
                      <div className='w-full mb-4'>
                          ...
                          <input className='w-full rounded disabled:bg-gray-100' type={'number'} name='build_yaer' placeholder='2015' value={buildYear} onChange={handleChangeBuildYear} disabled/>
                      </div>
                      <div className='w-full mb-4'>
                          <label>Body Mobil</label>
                          <select className='w-full rounded disabled:bg-gray-100' name='body_type' value={selectedBodyType} onChange={handleChangeBodyType} disabled>
                            {
                      ...
                      <div className='w-full mb-4'>
                          <div className='flex justify-between'>
                              <div className='mr-4'>
                                <label>KM</label>
                                <input className='w-full rounded disabled:bg-gray-100' type={'number'} name='distance' placeholder='20000' value={distance} onChange={handleChangeDistance} disabled/>
                              </div>
                              <div className='mr-4'>
                                <label>Bahan Bakar</label>
                                <select className='w-full rounded disabled:bg-gray-100' name='fuel' value={selectedFuel} onChange={handleChangeFuel} disabled>
                                  {
                                    fuels.map((fuel) => {
                                      return (
                              ...
                              <div>
                                ...
                                <select className='w-full rounded disabled:bg-gray-100' name='transmission' value={selectedTransmission} onChange={handleChangeTransmission} disabled>
                                  {
                      ...
                      <div className='w-full mb-4'>
                          ...
                          <textarea className='w-full h-32 rounded disabled:bg-gray-100' name='description' value={description} onChange={handleChangeDescription} disabled></textarea>
                      </div>
                      <div className='w-full mb-4'>
                          <label>Kota</label>
                          <select className='w-full rounded disabled:bg-gray-100' name='city' value={selectedCity} onChange={handleChangeCity} disabled>
                            {
                              cities.map((city) => {
                                return (
                      ...
                      <div className='w-full mb-4'>
                          ...
                          <select className='w-full rounded disabled:bg-gray-100' name='sub-district' value={selectedDistrict} onChange={handleChangeDistrict} disabled>
                            {
                      ...
                      <div className='w-full mb-4'>
                          ...
                          <input className='w-full rounded disabled:bg-gray-100' type={'text'} name='geo_point' value={coordinate} onChange={handleChangeCoordinate} disabled/>
                      </div>
                      <div className='w-full mb-4'>
                          <label>Harga Mobil (IDR)</label>
                          <input className='w-full rounded disabled:bg-gray-100' type={'number'} name='price' placeholder='200000000' value={price} onChange={handleChangePrice} disabled/>
                      </div>
                      <div className='w-full mb-4'>
                            ...
                            <div className="relative min:h-52">
                                  <div className="flex items-center justify-center w-full h-full">
                                      ...
                                      <label className="flex flex-col w-full h-full">
                                          ...
                                          <input type="file" className="opacity-0" onChange={onFileChange} multiple disabled/>
                                      </label>
                                  </div>
                              </div>
                          </div>
                      ...
                      <div className='flex justify-end'>
                        ...
                        <button onClick={onClickEdit} className='w-20 p-2 bg-indigo-700 font-bold rounded text-white' disabled={loadingSubmitted}>
                          {
                            loadingSubmitted ?
                            (
                              <div className='flex justify-center'>
